...
use App\Models\StudentDataPersonal;
use App\Models\StudentPersonalData;
use Illuminate\Http\Request;

class ReportReligiousGroup extends Controller
{
    protected $pdf;
    ...
    public function show ()
    {
        ...
        $this->pdf->Ln(3);
        $this->pdf->MultiCell(0,6, 'Religion Statistics', 0, 'C');
        ...
        $this->pdf->Cell(80, 6, 'Religion', $border, 0, 'L' );
        ...
        foreach($records as $record){
            ...
            $this->pdf->Cell(10, 7, '', 0, 0, 'C' );
            $this->pdf->Cell(80, 7, $record['grouping'], $border, 0, 'L' );
            $this->pdf->Cell(30, 7, $male, $border, 0, 'C' );
            $this->pdf->Cell(30, 7, $female, $border, 0, 'C' );
            $this->pdf->Cell(30.9, 7, $groupTotal, $border, 0, 'C' );
            $this->pdf->Cell(10, 7, '', 0, 0, 'C' );
            $this->pdf->SetFont('Times', '', 12);
            $this->pdf->Ln();
    ...
    private function data ($academicYearId)
    {
        ...
        {
            $group = [];
            $grouping = $religiousGroup->grouping;
