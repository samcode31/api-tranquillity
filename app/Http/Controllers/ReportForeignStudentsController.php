...
class ReportForeignStudentsController extends Controller
{
    protected $pdf;
    ...
    public function show ()
    {
        ...
        $this->pdf->Ln(3);
        $this->pdf->MultiCell(0,6, 'Foreign Students', 0, 'C');
        ...
        $this->pdf->Cell(40, 8, 'Country of Birth', $border, 0, 'L');
        $this->pdf->Cell(35.9, 8, 'Nationality', $border, 0, 'L');
        $this->pdf->SetFont('Times', '', 11);
        $this->pdf->Ln();

        $this->pdf->SetWidths(array(10, 25, 50, 20, 15, 40, 35.9));
        $this->pdf->SetAligns(array('C', 'C', 'L', 'C', 'C', 'L', 'L'));
    ...
    {
        return StudentPersonalData::join(
            'students',
            'students.id',
        ...
        ->select(
            ...
            'student_data_personal.country_of_birth',
            'student_data_personal.nationality',
        )
        ->where([
